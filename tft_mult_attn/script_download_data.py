...
def download_volatility(config):
  ...
  data_folder = '~/workspace/notebooks/public_datasets/volatility'
...
def download_electricity(config):
  ...
  # data_folder = config.data_folder
  data_folder = '~/workspace/notebooks/public_datasets/electricity'
...
def download_traffic(config):
  ...
  # data_folder = config.data_folder
  data_folder = '/home/tempuser/workspace/notebooks/public_datasets/traffic'
